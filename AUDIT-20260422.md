...
**Status**: [ ] PENDING — NOTE: heartbeat is legacy; Hermes cron is the v3 system
...
| 7 | MiniMax routing | LOW | Provider added, API 200, OpenAI endpoint wired | [x] FIXED 2026-04-22 (blog per-job routing deferred) |
| 8 | Docs drift | LOW | Update README + state JSON | [ ] PENDING |
